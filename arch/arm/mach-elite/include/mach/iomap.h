...
#define ELITE_ARM_PERIF_GIC_CPU_BASE    0xD8018100	/* Private GIC CPU interface */
#define ELITE_ARM_PERIF_GIC_DIST_BASE   0xD8019000	/* Private GIC distributor */
...
#define ELITE_DSP_CTRL_BASE                      0xD80EFC00
