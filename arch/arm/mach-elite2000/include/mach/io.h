...
#define IO_GIC400_PHYS 0xd9009000
#define IO_GIC400_VIRT (IO_L2CACHE_VIRT	+ IO_L2CACHE_SIZE )
#define IO_GIC400_SIZE SZ_16K

#define IO_PCIE_PHYS	0xcfff0000
//#define IO_PCIE_VIRT	(IO_L2CACHE_VIRT + IO_L2CACHE_SIZE)
//#define IO_PCIE_SIZE SZ_64K

#define IO_PCIE_VIRT   (IO_GIC400_VIRT + IO_GIC400_SIZE)
#define IO_PCIE_SIZE   SZ_64K
...
#define IO_ADDRESS(x) (\
	IO_TO_VIRT_BETWEEN((x), IO_ELITE_PHYS, IO_ELITE_SIZE)? \
        ...
        IO_TO_VIRT_BETWEEN((x), IO_GIC400_PHYS, IO_GIC400_SIZE)? \
                IO_TO_VIRT_XLATE((x), IO_GIC400_PHYS, IO_GIC400_VIRT): \
        IO_TO_VIRT_BETWEEN((x), IO_PCIE_PHYS, IO_PCIE_SIZE)? \
                IO_TO_VIRT_XLATE((x), IO_PCIE_PHYS, IO_PCIE_VIRT): 0)
