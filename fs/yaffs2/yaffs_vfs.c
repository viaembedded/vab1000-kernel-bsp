...
unsigned int yaffs_trace_mask =YAFFS_TRACE_ERROR|YAFFS_TRACE_BUG|YAFFS_TRACE_BAD_BLOCKS | YAFFS_TRACE_ALWAYS;
			...
			void *buff, size_t size)
{
	...
	struct yaffs_obj *obj = yaffs_inode_to_obj(inode);
	ENTER();
	yaffs_trace(YAFFS_TRACE_OS,"yaffs_getxattr \"%s\" from object %d",name, obj->obj_id);
...
static int yaffs_removexattr(struct dentry *dentry, const char *name)
{
	...
	struct yaffs_obj *obj = yaffs_inode_to_obj(inode);
	ENTER();
	yaffs_trace(YAFFS_TRACE_OS,"yaffs_removexattr of object %d", obj->obj_id);
	...
	yaffs_trace(YAFFS_TRACE_OS,"yaffs_removexattr done returning %d", error);
	LEAVE();
	return error;
}
...
static ssize_t yaffs_listxattr(struct dentry * dentry, char *buff, size_t size)
{
	...
	struct yaffs_obj *obj = yaffs_inode_to_obj(inode);
	ENTER();
	yaffs_trace(YAFFS_TRACE_OS,"yaffs_listxattr of object %d", obj->obj_id);
	...
	yaffs_trace(YAFFS_TRACE_OS,"yaffs_listxattr done returning %d", error);
	LEAVE();
	return error;
}
...
static void yaffs_read_inode(struct inode *inode)
{
	...
	ENTER();
	yaffs_trace(YAFFS_TRACE_OS,"yaffs_read_inode for %d", (int)inode->i_ino);
			      ...
			      struct yaffs_obj *obj)
{
	...
	ENTER();
	if (!sb) {
		yaffs_trace(YAFFS_TRACE_OS,"yaffs_get_inode for NULL super_block!!");
		LEAVE();
		return NULL;
	...
	if (!obj) {
		yaffs_trace(YAFFS_TRACE_OS,"yaffs_get_inode for NULL object!!");
		LEAVE();
		return NULL;

	}

	yaffs_trace(YAFFS_TRACE_OS,"yaffs_get_inode for object %d", obj->obj_id);
...
static void yaffs_put_super(struct super_block *sb)
{
	...
	yaffs_trace(YAFFS_TRACE_OS | YAFFS_TRACE_ALWAYS,"yaffs_put_super done");
